...
<div class="container">
  ...
  <div class="form-row">
    ...
    <input type="text" class="form-control" name="idaluno" value="<%out.print(request.getAttribute("idaluno"));%>">   
   </div>
  ...
  <div class="col-md-2 mb-3">
   ...
   <div class="form-row">
	<div class="col-md-2 mb-4">    
	    ...
	    <input type="text" class="form-control" id="" placeholder="Digite Complemento" name="complemento" value="<%out.print(request.getAttribute("complementa"));%>">
	</div> 
  
  	<div class="col-md-4 mb-4">    
    	<label for="bairro">Bairro</label>
    	<input type="text" class="form-control" id="bairro" placeholder="" name="bairro" value="<%out.print(request.getAttribute("bairro"));%>">
  	</div>
  
  	<div class="col-md-4 mb-4">    
	    <label for="cidade">Cidade</label>
	    <input type="text" class="form-control" id="cidade" placeholder="" name="cidade" value="<%out.print(request.getAttribute("cidade"));%>">
  	</div>
